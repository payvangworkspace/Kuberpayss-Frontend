      ...
      {missingFields.length > 0 && (
        <div className={styles.warningBar}>
          ...
          <span className={styles.warningText}>
            <strong>Incomplete Business Profile</strong> — please complete:
          </span>
          <span className={styles.warningChips}>
            {missingFields.map((field) => (
              <span key={field} className={styles.warningChip}>
                {field}
              </span>
            ))}
          </span>
