...
import AddCardNumber from "../modals/AddCardNumber";
import Headings from "./Headings";
import Table from "@/app/ui/table/Table";
import { blockCard } from "./Columns";
...
export default function BlockedCard({ type, userId, name }) {
  ...
  return (
    <>
      ...
      <Headings title="Blocked Card" action={() => setViewAddModal(true)} />
      <Table
        headers={blockCard}
        download={false}
        search={false}
