...
const Details = ({ role = false, userId = null, fullName = null }) => {
  ...
  if (loading)
    return <p className={styles.loadingState}>Please wait while fetching data</p>;
  if (error)
    return (
    ...
    <div className={styles.page}>
      <div className={styles.pageHeader}>
        <div>
          ...
          <h1 className={styles.title}>Fraud Prevention</h1>
          <p className={styles.subtitle}>
            Configure blocked values and limits for merchant risk controls
          </p>
        </div>
      </div>
      ...
      <div className={styles.layout}>
        <aside className={styles.sidebar}>
          ...
          <p className={styles.sidebarTitle}>Block Categories</p>
