...
import { validate } from "@/app/validations/forms/AmountLimitSetupValidation";
...
const Overlay = ({ merchant, type, id, onClick, onSuccess }) => {
  ...
  return (
    <div className={styles.modal}>
      <h6 className={styles.modalTitle}>Add Amount Limit</h6>
      ...
      <form id="add" onSubmit={handleSubmit}>
        <div className="row">
          <div className="col-12 mb-2">
            <Label htmlFor="value" label="Minimum Amount" required={true} />
            <input
              type="text"
              name="value"
              id="value"
          ...
          <div className="col-12 mb-3">
            <Label htmlFor="value2" label="Maximum Amount" required={true}/>
            <input
              type="text"
              name="value2"
              id="value2"
...
const AddAmountLimit = ({ merchant, type, id, onClose, onSuccess }) => {
  return (
    <Fragment>
      {createPortal(
