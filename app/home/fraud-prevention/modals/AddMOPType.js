  ...
  if (mopTypes)
    return (
      <div className={styles.modal}>
        <h6 className={styles.modalTitle}>Add MOP Type to Block</h6>
        ...
        <form id="add" onSubmit={handleSubmit}>
          <div className="row">
            <div className="col-12 mb-2">
              <Label htmlFor="value" label="Select MOP Type" required={true} />
              <Dropdown
...
const AddMOPType = ({ merchant, type, id, onClose, onSuccess }) => {
  return (
    <Fragment>
      {createPortal(
