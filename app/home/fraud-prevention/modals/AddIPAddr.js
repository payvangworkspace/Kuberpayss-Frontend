...
import { validate } from "@/app/validations/forms/AddIpAddValidation";
...
const Overlay = ({ merchant, type, id, onClick, onSuccess }) => {
  ...
  return (
    <div className={styles.modal}>
      <h6 className={styles.modalTitle}>Add IP Address</h6>
      ...
      <form id="add" onSubmit={handleSubmit}>
        <div className="row">
          <div className="col-12 mb-2">
            <Label htmlFor="value" label="Enter IP Address" required={true}/>
            <input
              type="text"
              name="value"
              id="value"
...
const AddIPAddr = ({ merchant, type, id, onClose, onSuccess }) => {
  return (
    <Fragment>
      {createPortal(
