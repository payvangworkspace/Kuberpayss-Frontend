...
import { validate } from "@/app/validations/forms/AddCustomerNameValidation";
...
const Overlay = ({ merchant, type, id, onClick, onSuccess }) => {
  ...
  return (
    <div className={styles.modal}>
      <h6 className={styles.modalTitle}>Add Customer Name</h6>
      ...
      <form id="add" onSubmit={handleSubmit}>
        <div className="row">
          <div className="col-12 mb-2">
            <Label htmlFor="value" label="Enter Customer Name" required={true}/>
            <input
              type="text"
              name="value"
              id="value"
...
const AddCustomerName = ({ merchant, type, id, onClose, onSuccess }) => {
  return (
    <Fragment>
      {createPortal(
