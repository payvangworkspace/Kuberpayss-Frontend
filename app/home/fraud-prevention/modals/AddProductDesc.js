...
import { validate } from "@/app/validations/forms/AddProductDescValidation";
...
const Overlay = ({ merchant, type, id, onClick, onSuccess }) => {
  ...
  return (
    <div className={styles.modal}>
      <h6 className={styles.modalTitle}>Add Product Description</h6>
      ...
      <form id="add" onSubmit={handleSubmit}>
        <div className="row">
          <div className="col-12 mb-2">
            <Label htmlFor="value" label="Enter Product Description" required={true}/>
            <textarea
              name="value"
              id="value"
              rows={5}
...
const AddProductDesc = ({ merchant, type, id, onClose, onSuccess }) => {
  return (
    <Fragment>
      {createPortal(
