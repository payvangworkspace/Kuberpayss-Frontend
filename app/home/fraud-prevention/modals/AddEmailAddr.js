...
import { validate } from "@/app/validations/forms/AddEmailValidation";
...
const Overlay = ({ merchant, type, id, onClick, onSuccess }) => {
  ...
  return (
    <div className={styles.modal}>
      <h6 className={styles.modalTitle}>Add Email Address</h6>
      ...
      <form id="add" onSubmit={handleSubmit}>
        <div className="row">
          <div className="col-12 mb-2">
            <Label htmlFor="value" label="Enter Email Address" required={true}/>
            <input
              type="email"
              name="value"
              id="value"
...
const AddEmailAddr = ({ merchant, type, id, onClose, onSuccess }) => {
  return (
    <Fragment>
      {createPortal(
