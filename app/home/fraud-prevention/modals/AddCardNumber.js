...
import { validate } from "@/app/validations/forms/AddCardNumberValidation";
...
const Overlay = ({ merchant, type, id, onClick, onSuccess }) => {
  ...
  return (
    <div className={styles.modal}>
      <h6 className={styles.modalTitle}>Add Card Number</h6>
      ...
      <form id="add" onSubmit={handleSubmit}>
        <div className="row">
          <div className="col-12 mb-2">
            <Label htmlFor="value" label="Enter Card Last 4-6 digit"  required={true}/>
            <input
              type="text"
              name="value"
              id="value"
              placeholder="Enter card last 4-6 digit"
              className="forminput"
...
const AddCardNumber = ({ merchant, type, id, onClose, onSuccess }) => {
  return (
    <Fragment>
      {createPortal(
